<script>
import ElCascaderPanel from 'element-legacy/packages/cascader-panel'
import ElInput from 'element-legacy/packages/input'
import ElScrollbar from 'element-legacy/packages/scrollbar'
import ElTag from 'element-legacy/packages/tag'
...
import { isFunction, isUndefined } from 'element-legacy/src/utils/types'
import { isEmpty, isEqual, kebabCase } from 'element-legacy/src/utils/util'
...
export default {
  ...
  computed: {
    realSize() {
      ...
      return this.size || _elFormItemSize || configSize
    },
    tagSize() {
      return ['small', 'mini'].includes(this.realSize)
        ? 'mini'
        : 'small'
    },
    isDisabled() {
...
<template>
  <div
    ref="reference"
    v-clickoutside="() => toggleDropDownVisible(false)" class="el-cascader"
    :class="[
  ...
  >
    ...
    >
      <template slot="suffix">
        ...
        <i
          v-else
          key="arrow-down"
          class="el-input__icon el-icon-arrow-down" :class="[
    ...
    <transition name="el-zoom-in-top" @after-leave="handleDropdownLeave">
      <div
        ...
        ref="popper"
        class="el-popper el-cascader__dropdown" :class="[popperClass]"
      >
        <ElCascaderPanel
          v-show="!filtering"
          ref="panel"
        ...
        >
          <template v-if="suggestions.length">
            <li
              ...
              :key="item.uid"
              class="el-cascader__suggestion-item" :class="[
