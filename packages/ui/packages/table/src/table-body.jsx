...
import { addClass, getStyle, hasClass, removeClass } from 'element-legacy/src/utils/dom'
...
export default {
  ...
  methods: {
    ...
    getRowClass(row, rowIndex) {
      ...
      if (this.store.states.expandRows.includes(row)) {
    ...
    handleCellMouseEnter(event, row) {
      ...
      const padding = (Number.parseInt(getStyle(cellChild, 'paddingLeft'), 10) || 0)
    ...
    rowRender(row, $index, treeRowData) {
      ...
      return (
        <TableRow
          ...
          isExpanded={this.store.states.expandRows.includes(row)}
          fixed={this.fixed}
        >
        </TableRow>
      )
