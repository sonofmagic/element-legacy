...
export default {
  ...
  watch: {
    showPopper(val) {
      if (val === true && Number.parseInt(this.popperJS._popper.style.zIndex, 10) < PopupManager.zIndex) {
  ...
  <transition name="el-zoom-in-top">
    ...
    >
      <div class="el-table-filter__content">
        <ElScrollbar wrap-class="el-table-filter__wrap">
          <ElCheckboxGroup v-model="filteredValue" class="el-table-filter__checkbox-group">
            <ElCheckbox
