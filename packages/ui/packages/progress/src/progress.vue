  ...
  computed: {
    ...
    radius() {
      if (this.type === 'circle' || this.type === 'dashboard') {
        return Number.parseInt(50 - Number.parseFloat(this.relativeStrokeWidth) / 2, 10)
      }
      else {
        return 0
      }
    ...
    <div v-if="type === 'line'" class="el-progress-bar">
      <div class="el-progress-bar__outer" :style="{ height: `${strokeWidth}px`, backgroundColor: defineBackColor }">
        <div class="el-progress-bar__inner" :style="barStyle">
          <div v-if="showText && textInside" class="el-progress-bar__innerText" :style="{ color: textColor }">
            {{ content }}
          </div>
        </div>
      </div>
