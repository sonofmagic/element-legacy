...
export default {
  ...
  computed: {
    ...
    sourceData() {
      return this.data.filter(item => !this.value.includes(item[this.props.key]))
    },
  ...
  methods: {
    ...
    addToRight() {
      ...
      this.data.forEach((item) => {
        ...
        if (
          this.leftChecked.includes(itemKey)
          && !this.value.includes(itemKey)
        ) {
...
<template>
  <div class="el-transfer">
    ...
    <div class="el-transfer__buttons">
      <ElButton
        type="primary"
        class="el-transfer__button" :class="[hasButtonTexts ? 'is-with-texts' : '']"
