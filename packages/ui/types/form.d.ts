import type { ValidateOption } from 'async-validator-next'
import type { ElementUIComponentSize } from './component'
...
export declare class ElForm extends ElementUIComponent {
  ...
  /** Options passed directly to async-validator-next */
   ...
   */
  validate(callback: ValidateCallback, options?: ValidateOption): void
  validate(options?: ValidateOption): Promise<boolean>
  /**
   ...
   */
  validateField(props: string | string[], callback?: ValidateFieldCallback, options?: ValidateOption): void
  validateField(props: string | string[], options?: ValidateOption): void
