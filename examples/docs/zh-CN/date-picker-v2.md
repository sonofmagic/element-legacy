...
| format            | 显示在输入框中的格式                           | string                                    | 见[日期格式](#/zh-CN/component/date-picker-v2#ri-qi-ge-shi)                                                                        | yyyy-MM-dd           |
...
| value-format      | 可选，绑定值的格式。不指定则绑定值为 Date 对象 | string                                    | 见[日期格式](#/zh-CN/component/date-picker-v2#ri-qi-ge-shi)                                                                        | —                    |
| name              | 原生属性                                       | string                                    | —                                                                                                                               | —                    |
