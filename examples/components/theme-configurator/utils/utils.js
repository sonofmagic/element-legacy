...
export function filterGlobalValue(defaultConfig, userConfig) {
  const valueObject = {}
...
export function getStyleDisplayValue(displayValue, global) {
...
export function getStyleDisplayName(config, componentName) {
...
export function getActionDisplayName(key) {
