...
:::demo Sélectionnez la date et l'heure avec DatePicker v2.
```html
<template>
  <el-date-picker-v2
...
<template>
  <div class="block">
    ...
    <el-date-picker-v2 v-model="value1" type="date" placeholder="Choississez un jour"> </el-date-picker-v2>
  </div>
  <div class="block">
    <span class="demonstration">Picker avec raccourcis</span>
    <el-date-picker-v2 v-model="value2" type="date" placeholder="Choississez un jour" :picker-options="pickerOptions">
    </el-date-picker-v2>
  </div>
</template>
...
<div class="container">
  <div class="block">
    ...
    <el-date-picker-v2 v-model="value1" type="week" format="Week WW" placeholder="Sélectionnez une semaine">
    </el-date-picker-v2>
  </div>
  <div class="block">
    <span class="demonstration">Mois</span>
    <el-date-picker-v2 v-model="value2" type="month" placeholder="Sélectionnez un mois"> </el-date-picker-v2>
  </div>
</div>
<div class="container">
  <div class="block">
    <span class="demonstration">Année</span>
    <el-date-picker-v2 v-model="value3" type="year" placeholder="Sélectionnez une année"> </el-date-picker-v2>
  </div>
  <div class="block">
    <span class="demonstration">Dates</span>
    <el-date-picker-v2 type="dates" v-model="value4" placeholder="Sélectionnez une ou plusieurs dates"> </el-date-picker-v2>
  </div>
</div>
...
<template>
  <div class="block">
    ...
    <el-date-picker-v2 v-model="value1" type="date" placeholder="Sélectionnez une date" default-value="2010-10-01">
    </el-date-picker-v2>
  </div>
  <div class="block">
...
| format            | Format d'affichage dans le champ.                                                        | string                                    | Voir [formats de date](#/fr-FR/component/date-picker-v2#formats-de-date).                                                           | yyyy-MM-dd           |
