      ...
      <el-col :span="14">
        <el-card shadow="hover" style="width: 100%">
          <div style="width: 100%; display: inline-block">
            <el-statistic :value="deadline2" time-indices title="🎉Price reduction of goods🎉">
              <template slot="suffix"> panic purchase </template>
            </el-statistic>
          </div>
        </el-card>
        <el-card shadow="hover" style="width: 100%; margin-top: 20px">
          <div style="width: 100%; display: inline-block">
            <el-statistic @finish="hilarity" :value="deadline3" time-indices title="The Value of Time">
              <template slot="suffix">
                <el-button type="primary " size="small" @click="add">add 10s</el-button>
              </template>
            </el-statistic>
          </div>
        </el-card>
      ...
      <el-col :span="10">
        <el-card shadow="hover" style="width: 100%">
          <div slot="header" class="clearfix">
            ...
            <el-button style="float: right; padding: 3px 0" type="text" @click="clickFn">suspend</el-button>
          </div>
          <div style="font-size: 16px; text-align: left">Don't sigh in the past, it is no longer back</div>
          <div style="font-size: 16px; text-align: left; margin-top: 15px">Be wise to improve the present</div>
