...
<div class="container">
  ...
  <div class="block">
    ...
    <pre class="demonstration"><code>Value: {{ JSON.stringify(value4) }}</code></pre>
...
<div class="container">
  <div class="block">
    ...
    <pre class="demonstration"><code>Value: {{ JSON.stringify(value5) }}</code></pre>
  ...
  <div class="block">
    ...
    <pre class="demonstration"><code>Value: {{ JSON.stringify(value6) }}</code></pre>
